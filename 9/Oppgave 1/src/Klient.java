...
public class Klient {
    ...
    public void start() {
        ...
        System.out.println("Hva er maks antall studenter?"); int maksAntStud = sc.nextInt();
        OppgaveOversikt oversikt = new OppgaveOversikt(maksAntStud);
        ...
        while(fortsett) {
            ...
            switch(visMeny) {
                ...
                case 5:
                    System.out.println(oversikt.skrivUtStudenter());
                    break;
